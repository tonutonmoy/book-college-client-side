    ...
    return (
        <div>
            ...
            <div className=" space-y-[50px]">
                ...
                <section >
                    <p className="text-[30px] text-[700] my-5">2.
                        <a className="text-red-500" href="https://www.loc.gov/"> Library of Congress</a></p>

                    <p className="ml-[30px]">As the largest library in the world, the Library of Congress is an amazing online resource for academic research. Students can search its collections to access digital resources, videos, audio recordings, photographs, and maps.
                ...
                <section >
                    <p className="text-[30px] text-[700] my-5">3.
                        <a className="text-red-500" href="https://www.ncbi.nlm.nih.gov/pmc/"> PubMed Central</a></p>

                    <p className="ml-[30px]">The National Library of Medicine, part of the U.S. National Institutes of Health, runs PubMed Central. Founded in 2000, the database includes academic scholarship dating back to the 18th century. The resource connects college students with life sciences and biomedical academic sources.
                ...
                <section>
                    <p className="text-[30px] text-[700] my-5">4.
                        <a className="text-red-500" href="https://www.science.gov/"> Science.govl</a></p>

                    <p className="ml-[30px]">If you're looking for scientific research, Science.gov is a great option. The site provides full-text documents, scientific data, and other resources from federally funded research.
                ...
                <section >
                    <p className="text-[30px] text-[700] my-5">5.
                        <a className="text-red-500" href="https://www.bestcolleges.com/blog/get-most-out-of-university-library/"> University Library</a></p>

                    <p className="ml-[30px]">If you've only walked through the campus library during a tour, you're missing out on all it can offer. Students benefit from research materials, subject-matter expertise, and even iPad rentals.

                        Your university library is more than just a repository for books — it's an information center with thousands of resources. Here's what you're missing out on if you skip the library.</p>
                </section>
